@extends("frontend.views.HomeView")
        ...
        <div class="container detail_poduct">
            <div class="img_product">
                ...
                <div class="img_prod_main" width="30%">
                    <img src="../assets/upload/products/photo; ?>" >
                </div>
            </div>
            ...
            <div class="info_product">
                <div>
                    ...
                    <h2 class="info_prod_name">  name</h2>
                </div>
                ...
                <div class="info_product_price">
                   <span style="margin-right:40px;color: red;text-decoration: line-through;">price?>VNĐ</span><span style="font-weight: bold";>  dsdsdđ</span>
                </div>
                  ...
                  <div style="border:1px solid #dddddd; margin-top: 15px;">
                    ...
                    <table style="width: 100%;">
                      <tr>
                        ...
                        <td><span class="label label-primary"> vote</span></td>
                      </tr>
      ...
      <!-- /rating -->
                 ...
                 <div class="info_product_descrip">
                    ...
                    <div class="btn btn_cart">
                        ...
                        <a href="{{ url('c')}}">Add cart <!-- <input type="button" value="Add cart"> --></a> 
    ...
    <section>
        <div class="container similar-prod products">
            ...
            <div class="list-product">
              <?php 
                $likeprod = DB::select("select * from products where id = 2");
               ?>
               @foreach($likeprod as $rows)
					<!-- start  -->
                <div class="item">
                    <div class="product">
                        ...
                        <div class="info-prod">
                            <div class="img-prod">
                               <img src="../assets/upload/products/id" />
                            </div>
                            <h3>{{ $rows->name }}</h3>
                            <div class="des-prod">
                               cescr

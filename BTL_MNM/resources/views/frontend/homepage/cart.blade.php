                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <a href="{{ url('customer/order')}}" class="btn " style="background-color:#da9347;height: 50px;width: 200px;color: white;border-radius: 8px;font-size: 20px;"> <i class="fi-rs-box-alt mr-10"></i> Thanh Toán</a>
                                </div>
                            </div>
                        </div>
                    </div>

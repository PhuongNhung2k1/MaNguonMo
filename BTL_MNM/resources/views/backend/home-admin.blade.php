    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('img/kinangsong2.jpg')}}" width="30px" height="30px" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Sidebar Types
                                    </span></a>
                                <ul class="collapse">
                            ...
                            <li>
                                </i><a href="{{ url('backend/categories')}}"><i class="ti-palette"></i><span>Danh mục sản phẩm</span></a>
                            </li>
                             <li>
                                <a href="{{ url('backend/products')}}"><i class="ti-layers-alt"></i> <span>Danh sách sản phẩm</span></a>
                            </li>
                             <li>
                                <a href="{{ url('backend/news')}}"><i class="ti-layers-alt"></i> <span>Danh mục tin tuc</span></a>
                            </li>
                             <li>
